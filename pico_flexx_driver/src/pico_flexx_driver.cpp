...
private:
  ...
  bool initialize()
  {
    ...
    std::string defaultFrameId = baseNameTF + PF_TF_OPT_FRAME;
    priv_nh.param("frame_id", frameId, defaultFrameId);
    ...
    OUT_INFO("parameter:" << std::endl
             ...
             << "                  frame_id: " FG_CYAN << frameId << NO_COLOR);
  ...
  bool getCameraSettings(royale::LensParameters &params)
  {
    ...
    OUT_INFO("access level: " FG_CYAN "L" << (int)accessLevel << NO_COLOR);
