...
def fit_curve(angles, volumes, fn=None, args=None, domain=None):
    ...
    x0 = [0.0] + list(np.full(POLYNOMIAL_ORDER , 0.0))
    # if args.scaled:
    ...
    if fn == '005':
        tol = 0.1
        x0 = [0.0] + list(np.full(POLYNOMIAL_ORDER , 1e-2))  #just added this as it wasn't working on desktop
        # tol = 0.1
    elif fn == '016':
        tol = 0.001
    elif fn == '015':
        ...
        x0 = [0.0] + list(np.full(POLYNOMIAL_ORDER , 1e-3))
    else:
        tol = 0.01
