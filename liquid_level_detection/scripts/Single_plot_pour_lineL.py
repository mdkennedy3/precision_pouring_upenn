...
#LOOK AT offset line to understand which side 
...
plt.title('Liquid Level Estimation Focused on Left w/LP Alpha = 0.05')
...
ani.save('LeftL_Pouring_LPA05.mp4',writer=mywriter,fps=1, extra_args=['-vcodec', 'libx264']) 
