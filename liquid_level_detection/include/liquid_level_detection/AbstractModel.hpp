...
namespace GRANSAC
{
    ...
    public:
        ...
        virtual std::tuple<VPFloat, std::vector<std::shared_ptr<AbstractParameter>>, std::vector<std::shared_ptr<AbstractParameter>>> EvaluateWithOutliers(const std::vector<std::shared_ptr<AbstractParameter>> &EvaluateParams, VPFloat Threshold) = 0;
